...
class Model(nn.Module):
    def __init__(self, configs, max_seq_len:Optional[int]=1024, d_k:Optional[int]=None, d_v:Optional[int]=None, norm:str='BatchNorm', attn_dropout:float=0., 
        ...
        patch_len = configs.patch_len[0]
        stride = configs.stride[0]
        ...
        self.model = HDMixer_backbone(configs,c_in=c_in, context_window = context_window, target_window=target_window, patch_len=patch_len,
                                  stride=stride, 
                                  ...
                                  subtract_last=subtract_last, verbose=verbose, **kwargs).to(self.device)
